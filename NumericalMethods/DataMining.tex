...
this chapter.
\begin{figure}
\center\psfig{figure=Figures/DataMiningClasses.eps, width=11cm}
...
\input{Java/DhbDataMining/AbstractDataServer.java}
\end{listing}
\begin{listing} Java memory based data server \label{lj:memoryserver}
\input{Java/DhbDataMining/MemoryBasedDataServer.java}
\end{listing}
...
\end{verbatim}
\noindent{\tt<\sl Creating an instance of a concrete subclass of
\tt AbstractDataServer\sl into the variable \tt dataServer>}
\begin{verbatim}
...
\input{Java/DhbDataMining/VectorAccumulator.java}
\end{listing}

\begin{listing} Java implementation of covariance matrix \label{lj:covmatrix}
\input{Java/DhbDataMining/CovarianceAccumulator.java}
\end{listing}
...
\begin{figure}
\center\psfig{figure=Figures/Mahalanobis.eps, width=12cm}
...
\noindent{\tt<\sl The variable \tt dataServer \sl is setup to read
the measurements to be sorted between accepted and rejected; the
{\tt double} variable \tt threshold \sl must also be determined or
given\tt>}
\begin{verbatim}
 dataServer.open();
 try {
...
\input{Java/DhbDataMining/MahalanobisCenter.java}
\end{listing}
...
2-dimensional case.
\begin{figure}
\center\psfig{figure=Figures/Clusters.eps, width=11cm}
...
\input{Java/DhbDataMining/Cluster.java}
\input{Java/DhbDataMining/ClusterFinder.java}
\end{listing}
...
\input{Java/DhbDataMining/EuclideanCluster.java}
\end{listing}
...
\input{Java/DhbDataMining/CovarianceCluster.java}
\end{listing}
